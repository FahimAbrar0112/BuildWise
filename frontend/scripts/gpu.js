...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (userData != null) {
    ...
    if (userData.username) {
      ...
      const account = document.querySelector('body > nav > div.nav-authentication > div > p');
      account.innerHTML = userData.username;
      const link1 = document.querySelector('body > nav > div.nav-authentication > div > div > a:nth-child(1)');
      link1.innerHTML = 'Profile';
      link1.href = '';
      const link2 = document.querySelector('body > nav > div.nav-authentication > div > div > a:nth-child(2)');
...
const Logout = document.querySelector('body > nav > div.nav-authentication > div > div > a:nth-child(2)');
  ...
  submitButton.addEventListener("click", () => {
    ...
    fetch("/backend/filterGPU", {
      ...
      .then((data) => {
        ...
        <a href="${postData.link}" class="card-link">
...
//     let arr = [];
//     cards.forEach((item) => {
//       const isvisible = item.product_name.toLowerCase().includes(value);
//       if (isvisible) {
//         console.log(item);
//         arr.push(item);
//         // console.log(item);
...
//   "body > main > div.filteroption > button"
// );
